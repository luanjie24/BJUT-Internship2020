...
def batchify_with_label(input_batch_list, gpu, volatile_flag=False):
    ...
    word_seq_lengths = word_seq_lengths.tolist()#new
    ...
    word_perm_idx =np.argsort(word_seq_lengths)
    word_seq_lengths = word_seq_lengths.sort(reverse=True)#sort(0,reverse=True)
    ...
    char_seq_lengths = char_seq_lengths.tolist()
    char_perm_idx = np.argsort(char_seq_lengths)
    char_seq_lengths = char_seq_lengths.sort(reverse=True)
    char_seq_tensor = char_seq_tensor[char_perm_idx]
    char_perm_idx = char_perm_idx.tolist()
    word_perm_idx = word_perm_idx.tolist()
    char_seq_recover = char_perm_idx.sort(reverse=False)
    word_seq_recover = word_perm_idx.sort(reverse=False)
