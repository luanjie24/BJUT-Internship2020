...
class CRF(nn.Module):
    ...
    def _viterbi_decode(self, feats, mask):
        ...
        print(seq_len)
        print(batch_size)
        print(x.shape for x in partition_history) 
        print(type(x)for x in partition_history) 
        ...
        print(partition_history)
        print(torch.cat((partition_history),0).view(seq_len, batch_size,-1).transpose(1,0).contiguous())
